...
**Licence audit for en_GB-vctk-medium (do this again for any different voice — never assume one is commercial-safe just because Piper itself is):**
| Layer | Licence | Commercial use | Redistribute generated audio | Attribution |
|---|---|---|---|---|
| Piper engine (software) | MIT | Yes | — | No |
| This voice model file | MIT (per its own `MODEL_CARD` on Hugging Face) | Yes | Yes | No |
